...
> = (props) => {
    ...
    useEffect(() => {
        ...
        return cleanup;
    }, [handleLogoAnimation, cleanup, fabricateHandleWindowResize, addCleanup]);
    ...
    // lifecycle.
    return (
        <div ref={navbarIndicatorRef} className={styles.navbarIndicator}></div>
    );
};
